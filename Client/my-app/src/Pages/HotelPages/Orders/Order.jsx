...
//   // Lấy restaurantId và token từ localStorage nếu Context chưa có
...
//   useEffect(() => {
//     // Nếu thiếu thông tin thì không gọi
...
//   // UI trống khi chưa có token/userId (tránh lỗi)
//   if (!token || !restaurantId) {
//     return (
//       <div className="order-container">
//         <p style={{ padding: 16 }}>
//           Chưa có thông tin đăng nhập nhà hàng. Hãy đăng nhập lại với tài khoản
//           <b> Restaurant</b>.
//         </p>
//       </div>
//     );
